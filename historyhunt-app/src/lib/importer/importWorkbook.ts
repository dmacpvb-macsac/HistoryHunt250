...
function normalizeHuntInfoForRpc(huntInfo: HuntInfo, totalPoints: number, questionCount: number, siteOrigin: string) {
  ...
  return {
    ...
    registration_required: huntInfo.gameType === 'kidz' ? false : huntInfo.registrationRequired,
    allow_anonymous_players: huntInfo.gameType === 'kidz' ? true : huntInfo.allowAnonymousPlayers,
